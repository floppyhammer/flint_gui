...
void Sprite2d::update_mvp() {
    ...
    //    // 1.
    //    mvp.model =
    //        glm::scale(mvp.model, glm::vec3(scaled_size.x / view_size.x * 2.0f, scaled_size.y / view_size.y
    //        * 2.0f, 1.0f));
    //
...
void Sprite2d::draw(VkRenderPass render_pass, VkCommandBuffer cmd_buffer) {
    ...
    //    vkCmdPushConstants(
    //        p_command_buffer, pipeline_layout, VK_SHADER_STAGE_VERTEX_BIT, 0, sizeof(MvpPushConstant),
    //        &push_constant);
    //
